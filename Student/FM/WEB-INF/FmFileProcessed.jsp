    ...
    <div class="container-fluid">
                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>FM</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li class="active"><a href="FmFileProcessed.action">电台目标文件</a></li>
				...
				<table style="width: 900px;">
					...
					<td>
						<div class="form-group input-group" style="width: 180px;">
								<span class="input-group-addon">源文件id</span> <input type="text"
									class="form-control" placeholder="文件id" id="txt_fileId" style="height:30px">
							</div>
						</td>
						<td>
							<div class="form-group input-group" style="width: 180px;">
		...
		<div id="table_wrapper"
			...
			<table width="100%"
				...
				id="table_fmfileprocessed" role="grid" style="width: 100%;">
				<thead>
					<tr role="row">
						<th class="sorting_asc" aria-controls="table_fmfileprocessed"
							aria-sort="ascending" style="width: 70px;"></th>
						<th class="sorting_asc" aria-controls="table_fmfileprocessed"
							aria-sort="ascending" style="width: 50px;">序号</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 50px;">Id</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 25px;">频道id</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 50px;">源文件id</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 50px;">目标文件地址</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 107px;">说明</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 107px;">预计播放时间</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
							style="width: 107px;">结束播放时间</th>
						<th class="sorting" aria-controls="table_fmfileprocessed"
...
<script type="text/javascript">
	...
	function edit(i){
		$.ajax({
			type : 'POST',
			url : "ModifyFmFileProcessed.action",
			data : curRow[i],
			dataType : 'JSON',
								...
								dt = $('#table_fmfileprocessed')
											...
											"fnDrawCallback" : function(
												...
												api.column(6).nodes().each(
														function(cell,i) {
															cell.innerHTML = "<a href='#' id='" + "tableCell_" + i + "_7" +"' data-type='text' data-title='expl'>" + cell.innerHTML + "</a>";
											...
											"sAjaxSource" : "FmFileProcessedAction.action?rand="
													+ Math.random(),
