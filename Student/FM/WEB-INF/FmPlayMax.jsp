    ...
    <div class="container-fluid">
                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu"><i class="icon-dashboard"></i>FM</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li class="active"><a href="FmPlayMax.action">最大频道播放</a></li>
		...
		<div id="table_wrapper"
			...
			<table width="100%"
				...
				id="table_fmplaymax" role="grid" style="width: 100%;">
				<thead>
					<tr role="row">
						<th class="sorting_asc" aria-controls="table_fmplaymax"
							aria-sort="ascending" style="width: 70px;"></th>
						<th class="sorting_asc" aria-controls="table_fmplaymax"
							aria-sort="ascending" style="width: 50px;">序号</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 50px;">Id</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 50px;">频道id</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 250px;">频道最大播放时间</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 50px;">序号</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 107px;">频道名</th>
						<th class="sorting" aria-controls="table_fmplaymax"
							style="width: 107px;">最大播放序号</th>
						<th class="sorting" aria-controls="table_fmplaymax"
								...
								dt = $('#table_fmplaymax')
											...
											"fnDrawCallback" : function(
												...
												api.column(6).nodes().each(
														function(cell,i) {
															cell.innerHTML = "<a href='#' id='" + "tableCell_" + i + "_6" +"' data-type='text' data-title='channelName'>" + cell.innerHTML + "</a>";
															$("#tableCell_" + i + "_6").editable({
																url : function(params) {
																	curRow[i]["id"] = dt.row(i).data()["id"];
																	curRow[i]["channelName"] = params.value;
																}
															});
														});
												api.column(7).nodes().each(
														function(cell,i) {	
															cell.innerHTML = "<a href='#' id='" + "tableCell_" + i + "_7" + "' data-type='text' data-title='fileIdMax'>" + cell.innerHTML + "</a>";
															$("#tableCell_" + i + "_7").editable({
																url : function(params) {
																	curRow[i]["id"] = dt.row(i).data()["id"];
																	curRow[i]["fileIdMax"] = params.value;
																}
															});
														});
											...
											"sAjaxSource" : "FmPlayMaxAction.action?rand="
													+ Math.random(),
