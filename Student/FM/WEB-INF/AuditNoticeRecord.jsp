            ...
            <div class="span3">
                ...
                <ul id="legal-menu" class="nav nav-list collapse in">
                  ...
                  <li ><a href="terms-and-conditions.action">音频文件库</a></li>
                   <li class="active"><a href="AuditNoticeRecord.action">审核通信记录</a></li>
      ...
      <div class="panel-body">
					...
					<tr>
						...
						<div class="form-group input-group" style="width: 180px;">
								<span class="input-group-addon">标题名</span> <input type="text"
									class="form-control" placeholder="文件id" id="txt_title" style="height:30px">
							</div>
						</td>
						<td>
							<div class="form-group input-group" style="width: 180px;">
								<span class="input-group-addon">作者id</span> <input type="text"
									class="form-control" placeholder="作者id" id="txt_userId" style="height:30px">
							</div>
						</td>
		...
		<div id="table_wrapper"
			...
			<table width="100%"
				...
				id="table_auditnoticerecord" role="grid" style="width: 100%;">
				<thead>
					<tr role="row">
						<th class="sorting_asc" aria-controls="table_auditnoticerecord"
							aria-sort="ascending" style="width: 70px;"></th>
						<th class="sorting_asc" aria-controls="table_auditnoticerecord"
							aria-sort="ascending" style="width: 50px;">序号</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 50px;">id</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 50px;">作者id</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 100px;">作品标题</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 50px;">作品id</th>
						<th class="sorting" aria-controls=table_auditnoticerecord
							style="width: 50px;">文件时长</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 107px;">审核时间</th>						
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 50px;">审核状态</th>
						<th class="sorting" aria-controls="table_auditnoticerecord"
							style="width: 200px;">通讯记录</th>							
						<th class="sorting" aria-controls="table_auditnoticerecord"
...
<script type="text/javascript">
	...
	function edit(i){
		$.ajax({
			type : 'POST',
			url : "ModifyAuditNoticeRecord.action",
			data : curRow[i],
			dataType : 'JSON',
					...
					function() {
								...
								dt = $('#table_auditnoticerecord')
											...
											"fnDrawCallback" : function(
												...
												api.column(9).nodes().each(
														function(cell,i) {	
															cell.innerHTML = "<a href='#' id='" + "tableCell_" + i + "_9" + "' data-type='text' data-title='noticeRecord'>" + cell.innerHTML + "</a>";
															$("#tableCell_" + i + "_9").editable({
																url : function(params) {
																	curRow[i]["id"] = dt.row(i).data()["id"];
																	curRow[i]["noticeRecord"] = params.value;
																}
															});
														});
						
												api.column(10).nodes().each(
														function(cell,i) {	
											...
											"sAjaxSource" : "AuditNoticeRecordAction.action?rand="
													+ Math.random(),
